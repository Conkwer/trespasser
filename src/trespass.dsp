...
; Debug/dev build: uncomment line below for faster builds with debug info
...
; Debug/dev build: keep line below active for debug info
# ADD LINK32 lib\smacker\smackw32.lib build\release\view\view.lib build\release\system\system.lib build\release\audio\audio.lib build\release\ai\AI.lib build\release\game\Game.lib build\release\geomdbase\GeomDBase.lib build\release\loader\Loader.lib build\release\math\Math.lib build\release\physics\Physics.lib build\release\render3d\Render3D.lib build\release\ScreenRenderDWI\ScreenRenderDWI.lib build\release\std\Std.lib build\release\entitydbase\EntityDBase.lib build\release\file\File.lib build\release\winshell\WinShell.lib C:\dx7asdk\DXF\lib\ddraw.lib C:\dx7asdk\DXF\lib\d3dim.lib comctl32.lib winmm.lib dsound.lib kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib lz32.lib version.lib /nologo /stack:0x100000 /subsystem:windows /incremental:no /debug /debugtype:both /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libci" /SECTION:SelfMod,ERW
; Release/stripped build: uncomment line below to strip debug info
; # ADD LINK32 lib\smacker\smackw32.lib build\release\view\view.lib build\release\system\system.lib build\release\audio\audio.lib build\release\ai\AI.lib build\release\game\Game.lib build\release\geomdbase\GeomDBase.lib build\release\loader\Loader.lib build\release\math\Math.lib build\release\physics\Physics.lib build\release\render3d\Render3D.lib build\release\ScreenRenderDWI\ScreenRenderDWI.lib build\release\std\Std.lib build\release\entitydbase\EntityDBase.lib build\release\file\File.lib build\release\winshell\WinShell.lib C:\dx7asdk\DXF\lib\ddraw.lib C:\dx7asdk\DXF\lib\d3dim.lib comctl32.lib winmm.lib dsound.lib kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib lz32.lib version.lib /nologo /stack:0x100000 /subsystem:windows /incremental:no /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libci" /SECTION:SelfMod,ERW
