...
# ADD LINK32 lib\smacker\smackw32.lib comctl32.lib winmm.lib dsound.lib kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib lz32.lib version.lib /nologo /stack:0x100000 /subsystem:windows /incremental:no /debug /debugtype:both /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libci" /SECTION:SelfMod,ERW
; Release/stripped build: uncomment line below to strip debug info
; # ADD LINK32 lib\smacker\smackw32.lib comctl32.lib winmm.lib dsound.lib kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib lz32.lib version.lib /nologo /stack:0x100000 /subsystem:windows /incremental:no /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libci" /SECTION:SelfMod,ERW
